...
def run_translation_experiment(model, tokenizer, sentence, interest_threshold, save_path, xlabel, legend):
    ...
    interpolation_factors = np.linspace(0, 10, 100, endpoint=True)
